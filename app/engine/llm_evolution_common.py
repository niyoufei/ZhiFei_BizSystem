...
def _build_few_shot_prompt_lines(report: Dict[str, Any]) -> List[str]:
    rows = report.get("few_shot_examples")
...
def build_evolution_prompt(
    ...
    few_shot_lines = _build_few_shot_prompt_lines(report)
    if few_shot_lines:
        lines.append("\n已采纳高分少样本示例：")
        lines.extend(few_shot_lines)
