...
class ReadyResponse(BaseModel):
    ...
    details: dict = Field(default_factory=dict, description="各组件就绪检查详情")
...
class ProjectCreate(BaseModel):
    ...
    bid_method: Optional[str] = Field(None, description="评标方式")
...
class ExtractedFeature(BaseModel):
    ...
    source_project_ids: List[str] = Field(default_factory=list, description="来源项目ID列表")
